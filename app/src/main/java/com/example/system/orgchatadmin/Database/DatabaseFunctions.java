...
public class DatabaseFunctions {
    ...
    public static String createMessageTable(){
        ...
        return "CREATE TABLE MESSAGE (MESSAGE_ID VARCHAR PRIMARY KEY , SENDER_ID VARCHAR , TITLE VARCHAR , MESSAGE VARCHAR , MESSAGE_TYPE VARCHAR , TIME VARCHAR , SUBDEPARTMENT_ID VARCHAR , RW VARCHAR) ";
    }
