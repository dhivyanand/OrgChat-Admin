...
public class HomeSuggestion extends AppCompatActivity {
    ...
    public void updateUI(){
        try{
            ...
            Cursor resultSet = mydatabase.rawQuery("Select TITLE, TIME, MESSAGE_ID, SENDER_ID , SUBDEPARTMENT_ID , RW from MESSAGE where MESSAGE_TYPE = 'S' ",null);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nosug = (TextView)findViewById(R.id.nosug);
        ...
        adapter = new MessageAdapter(HomeSuggestion.this, compliant, date, subdept_id,status);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("message_type","Suggestion");
